...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.dicoding.salsahava.mymediaplayer.mediaservice.create"
        const val ACTION_DESTROY = "com.dicoding.salsahava.mymediaplayer.mediaservice.destroy"
        const val PLAY = 0
        const val STOP = 1
    }
