package com.dicoding.salsahava.customnotif
...
import com.dicoding.salsahava.customnotif.NotificationService.Companion.CHANNEL_ID
import com.dicoding.salsahava.customnotif.NotificationService.Companion.CHANNEL_NAME
import com.dicoding.salsahava.customnotif.NotificationService.Companion.REPLY_ACTION
import com.dicoding.salsahava.customnotif.databinding.ActivityReplyBinding
...
class ReplyActivity : AppCompatActivity() {
    ...
    private fun updateNotification(notifyId: Int) {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_baseline_notifications_white_48)
