package com.dicoding.salsahava.stacknotif
...
import com.dicoding.salsahava.stacknotif.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSend.setOnClickListener {
            ...
            if (sender.isEmpty() || message.isEmpty()) Toast.makeText(this@MainActivity, "Data harus diisi", Toast.LENGTH_SHORT).show()
            else {
    ...
    private fun sendNotif() {
        ...
        val largeIcon = BitmapFactory.decodeResource(resources, R.drawable.ic_baseline_notifications_white_48)
        ...
        if (idNotification < MAX_NOTIFICATION) {
            mBuilder = NotificationCompat.Builder(this, CHANNEL_ID)
                    ...
                    .setSmallIcon(R.drawable.ic_baseline_mail_white_48)
