package com.dicoding.salsahava.mywidgets
...
import com.dicoding.salsahava.mywidgets.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startJob() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) builder.setPeriodic(900000) // 15 mins
        else builder.setPeriodic(SCHEDULE_OF_PERIOD) // 3 mins
