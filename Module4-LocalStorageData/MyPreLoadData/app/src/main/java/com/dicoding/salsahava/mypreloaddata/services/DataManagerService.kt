package com.dicoding.salsahava.mypreloaddata.services

import android.app.Service
import android.content.Intent
import android.os.*
import android.util.Log
import com.dicoding.salsahava.mypreloaddata.R
...
import com.dicoding.salsahava.mypreloaddata.pref.AppPreference
    ...
    */
    ...
    private fun loadDataAsync() {
        ...
        job = launch {
            ...
            if (isInsertSuccess.await()) sendMessage(SUCCESS_MESSAGE)
            else sendMessage(FAILED_MESSAGE)
        }
        job.start()
    }
